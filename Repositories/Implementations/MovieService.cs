...
namespace Movie_App.Repositories.Implementations
{
    public class MovieService : IMovieService
    {
            ...
            public bool Update(Movie model)
            {
                try
                {
                    ...
                    var genresToDeleted = ctx.MovieGenre
                        .Where(a => a.MovieId == model.Id && !model.Genres.Contains(a.GenreId)).ToList();
                    ...
                    {
                        var movieGenre =
                            ctx.MovieGenre.FirstOrDefault(a => a.MovieId == model.Id && a.GenreId == genId);
                        if (movieGenre == null)
                        {
